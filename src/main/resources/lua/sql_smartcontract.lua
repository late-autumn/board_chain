...
function constructor()
  ...
  db.exec([[create table if not exists t_jpa_board(
        board_idx INTEGER PRIMARY KEY AUTOINCREMENT,
        contents text,
        title text,
        hit_cnt INTEGER,
...
--게시글 생성
function BoardCreate(board_idx, contents, title, hit_cnt, created_datetime, creator_id, updated_datetime, updater_id, ...)
  db.exec("INSERT INTO t_jpa_board (board_idx, contents, title, hit_cnt, created_datetime, creator_id, updated_datetime, updater_id) VALUES('"
  .. board_idx .. "', '"
  .. contents .. " " .. title .. "', '"
